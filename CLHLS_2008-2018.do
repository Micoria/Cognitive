...
use "$raw_data\clhls\clhls_2008_2018_longitudinal_dataset.dta", clear 
...
count if dth11_14==0 // surviving sample during 08-14:5,245(2008, 2011, 2014)
...
*性别
recode a1 (1=1) (2=0), gen(sex)  // 男为1,女为0
label define sex_lbl 1 "男" 0 "女"
label values sex sex_lbl

*民族
recode a2 (1=1) (2/8=0),gen(ethnic)  //汉族为1,非汉族为0
...
*婚姻状况
recode f41 (2/5=0), gen(marital_08) // living without partners(separated,divorced,widowed,never married)=0,currently married and living with spouse=1
...
*上一年家庭收入
recode f35 (99999=.),gen(income_08)  // total income of your household last year 超过 10 万元：99998
...
recode d91_18 (1=1) (2=0)(9=.), gen(exercise_18)
...
recode cesd (0/15=0)(16/30=1),gen(cesd_d) //常见的 cutoff 值是 16 分,其cutoff 可能会根据特定研究或临床环境而有所不同如10,20 
label define cesd_lbl 0 "无抑郁症状" 1 "有抑郁症状"
label values cesd_d cesd_lbl

*日常生活活动能力
*ADL6个项目bathing, dressing, eating, indoor transferring, toileting, and continence,每个项目的分值范围是0到2分,将每个 ADL 项目的分值相加,得到总得分
...
label define adl_lbl 0 "无残疾" 1 "有残疾"
label values adl_d_08 adl_d_11 adl_d_14 adl_d_18 adl_lbl


*认知功能
*简易精神状态评价量表(Mini-mental State *Examination,MMSE)中文版,该量表包括一般能力(12分)、反应能力(3分)、注意力与计算力(6分)、回忆力(3分)、语言理解与自我协调能力(6分)5*个部分24个问题,总分30分,分数越高,表示认知功能水平越高
...
label var uebmi_18 "是否有城职保/城居保_18"
label var nrcm_18 "是否有新农合_18"
...
label var adl_d_08 "ADL_08"
label var adl_d_11 "ADL_11"
label var adl_d_14 "ADL_14"
label var adl_d_18 "ADL_18"
label var mmse_08 "认知能力_08"
label var mmse_11 "认知能力_11"
label var mmse_14 "认知能力_14"
label var mmse_18 "认知能力_18"
label var mmse_d_08 "是否认知障碍_08"
label var mmse_d_11 "是否认知障碍_11"
label var mmse_d_14 "是否认知障碍_14"
label var mmse_d_18 "是否认知障碍_18"
...
keep trueage_08 trueage_11 trueage_14 trueage_18 sex ethnic birth_place edu_08 ///
  ...
  exercise_11 exercise_14 exercise_18 cesd_d cesd adl_d_08 adl_d_11 adl_d_14 adl_d_18 ///
  mmse_08 mmse_11 mmse_14 mmse_18 mmse_d_08 mmse_d_11 mmse_d_14 mmse_d_18 yearin dth08_11 dth11_14 dth14_18 id
